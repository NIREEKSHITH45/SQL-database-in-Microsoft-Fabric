...
3.  Click on **New Query**, paste the following query, and then click on **Run** button.
...
4. Click on **New Query**, paste the following query, and then click on **Run** button.
...
5. Click on **New Query**, paste the following query, and then click on **Run** button.
...
6. Click on **New Query**, paste the following query in the query editor, and then click on **Run** button.
...
1. Click on **New Query**, paste the following query in the query editor, and then click on **Run** button.
